            ...
            <div className='container' style={{ marginTop: '50px' }}>
                ...
                <Grid container spacing={5} style={{marginTop:'30px', display: 'flex', justifyContent: 'flex-start'}}>
                    <Grid item xs={12} sm={4}>
                        ...
                        <IconButton>
                            <a href="http://lattes.cnpq.br/7921008631169151" target="_blank" style={{textDecoration: 'none'}}>
                ...
                <Grid container spacing={5} style={{marginTop:'30px', display: 'flex', justifyContent: 'flex-end'}}>
                    <Grid item xs={12} sm={4}> 
                            ...
                            <IconButton>
                            <a href="http://lattes.cnpq.br/4668190439671783" target="_blank" style={{textDecoration: 'none'}}>
                                <img src={lattes} style={{width: '1em', height: '1em'}} />
                            </a>
                            </IconButton>
                            <IconButton>
                ...
                <Grid container spacing={5} style={{marginTop:'30px', justifyContent: 'center'}}>
                    ...
                    <Grid item xs={12} sm={4}>
                            ...
                            <IconButton>
                            <a href="http://lattes.cnpq.br/0260360273826418" target="_blank" style={{textDecoration: 'none'}}>
                                <img src={lattes} style={{width: '1em', height: '1em'}} />
                            </a>
                            </IconButton>
                            <IconButton>
